...
import {StyledNavUl, StyledNav, StyledNavWrapper, StyledNavLi, NavWrapper} from "./styles"
...
const getNavList = (pagesCatalog, deviceStr, isOpenPopup) => {
    ...
    for (let pagesCatalogKey in pagesCatalog) {
        ...
        content.push(<StyledNavLi key={item.id} isOpenPopup={isOpenPopup}><CustomLink isOpenPopup={isOpenPopup}
                                                                                      key={item.id}
                                                                                      to={item.path}>{item.value}</CustomLink></StyledNavLi>)
    }
    return (
